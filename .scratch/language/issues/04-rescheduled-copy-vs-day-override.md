...
Resolved. **Code copy wins**.
- "Rescheduled" is intuitive, human-centered lifter copy for moving a workout day.
- "Day override" / `dayPlan` / `dayOverrideSheet` describe the underlying mechanism and modal.
- [CONTEXT.md](file:///c:/Users/USER/Desktop/Work/Projects/opengym-main/opengym-main/CONTEXT.md) updated under **Day override (Rescheduled)** to formalize "Rescheduled" as the UI copy for day overrides.
